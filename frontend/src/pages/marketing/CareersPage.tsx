import { Badge, Box, Button, Card, Container, Grid, Stack, Text, Title } from "@mantine/core";
import { Link } from "react-router-dom";

const VALUES = [
  { icon: "🔧", title: "Proof over polish", body: "We judge work by what it does in the field, not how it pitches." },
  { icon: "📍", title: "Local by default", body: "Decisions live close to the nodes and the pros they affect." },
  { icon: "⚡", title: "Bias to dispatch", body: "Speed is a feature. We move, measure, and adjust." },
  { icon: "🤝", title: "Pros come first", body: "If it doesn't help a tradesperson earn, we don't ship it." },
];
          ...
          {VALUES.map((v) => (
            <Grid.Col key={v.title} span={{ base: 12, sm: 6, md: 3 }}>
              <Card withBorder shadow="xs" radius="lg" p="md" h="100%">
                <Text style={{ fontSize: 22 }} mb="sm">{v.icon}</Text>
